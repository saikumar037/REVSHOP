...
public class ConsoleColors {
    ...
    public static String option(String number, String text) {
    ...
    public static String productInfo(String text) {
        return WHITE_BRIGHT + text + RESET;
    }

    public static String price(String text) {
    ...
    public static String orderStatus(String text) {
        return PURPLE_BOLD + text + RESET;
    }

    public static String notification(String text) {
